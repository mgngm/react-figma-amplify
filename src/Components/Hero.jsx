    ...
    return (
        <div className="flex flex-col gap-24">
            <div className="flex flex-col gap-20">
                <div className="flex flex-col lg:flex-row pt-24 px-8 justify-center items-center gap-32">
                    <div style={{ maxWidth: "420px" }} className="flex flex-col gap-8 items-start dark:text-white text-purple-med">
                        <div>
                            <h1 className="text-7xl font-bold">Amplify Playground</h1>
                    ...
                    <div className="relative w-full max-w-lg">
                        <img src="https://soundy.cloud/assets/bubble.png" alt="image" width="100%" className="absolute sm:-bottom-40 md:-right-28 left-0 bottom-0 animate-float z-40" />
                    </div>
                </div>
            </div>
        </div>
